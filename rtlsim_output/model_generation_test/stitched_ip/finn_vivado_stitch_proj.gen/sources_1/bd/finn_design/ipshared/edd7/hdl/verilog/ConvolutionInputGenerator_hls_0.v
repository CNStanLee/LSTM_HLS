...
(* CORE_GENERATION_INFO="ConvolutionInputGenerator_hls_0_ConvolutionInputGenerator_hls_0,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu7ev-ffvc1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.889937,HLS_SYN_LAT=95,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=174,HLS_SYN_LUT=585,HLS_VERSION=2022_2}" *)

module ConvolutionInputGenerator_hls_0 (
        ap_clk,
        ap_rst_n,
        in0_V_TVALID,
        out_V_TREADY,
...
wire   [0:0] icmp_ln1907_fu_161_p2;
wire   [0:0] we_fu_194_p2;
wire   [0:0] icmp_ln1924_fu_234_p2;
...
reg   [0:0] icmp_ln1907_reg_367;
reg   [0:0] icmp_ln1907_reg_367_pp0_iter1_reg;
reg   [0:0] re_reg_371;
reg   [0:0] re_reg_371_pp0_iter1_reg;
reg    ap_predicate_op72_write_state3;
reg    ap_block_state3_pp0_stage0_iter2;
reg    ap_block_state3_io;
wire    ap_CS_iter2_fsm_state3;
reg   [1:0] ap_CS_iter3_fsm;
reg   [0:0] icmp_ln1907_reg_367_pp0_iter2_reg;
reg   [0:0] re_reg_371_pp0_iter2_reg;
...
wire   [0:0] icmp_ln1907_reg_367_pp0_iter0_reg;
wire   [0:0] re_fu_176_p2;
wire   [0:0] re_reg_371_pp0_iter0_reg;
reg   [0:0] we_reg_375;
wire   [0:0] we_reg_375_pp0_iter0_reg;
reg   [0:0] icmp_ln1924_reg_379;
wire   [0:0] icmp_ln1924_reg_379_pp0_iter0_reg;
reg   [7:0] in0_V_read_reg_383;
...
reg    buffer_V_ce1;
reg    buffer_V_we1;
wire   [63:0] zext_ln1912_fu_253_p1;
wire   [63:0] zext_ln1925_fu_302_p1;
reg   [6:0] i_fu_72;
wire   [6:0] i_2_fu_167_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_i_1;
reg   [31:0] wp_fu_76;
wire   [31:0] wp_2_fu_319_p3;
reg   [31:0] ocnt_fu_80;
wire   [31:0] ocnt_2_fu_212_p3;
reg   [31:0] ap_sig_allocacmp_ocnt_load;
reg   [31:0] rp_fu_84;
wire   [31:0] rp_2_fu_286_p3;
reg   [31:0] inp_count_fu_88;
wire   [31:0] inp_count_1_fu_228_p2;
reg   [31:0] ap_sig_allocacmp_inp_count_load;
wire   [0:0] icmp_ln1910_fu_182_p2;
wire   [0:0] icmp_ln1910_1_fu_188_p2;
wire   [31:0] ocnt_1_fu_200_p2;
wire   [0:0] icmp_ln1921_fu_206_p2;
wire   [31:0] rp_1_fu_258_p2;
wire   [30:0] tmp_fu_264_p4;
wire   [0:0] icmp_ln1916_fu_274_p2;
wire   [31:0] add_ln1916_fu_280_p2;
wire   [31:0] wp_1_fu_307_p2;
wire   [0:0] icmp_ln1926_fu_313_p2;
...
ConvolutionInputGenerator_hls_0_buffer_V_RAM_S2P_LUTRAM_1R1W #(
    .DataWidth( 8 ),
    .AddressRange( 2 ),
    .AddressWidth( 1 ))
buffer_V_U(
    ...
    .ce1(buffer_V_ce1),
    .we1(buffer_V_we1),
    .d1(in0_V_read_reg_383)
);

ConvolutionInputGenerator_hls_0_flow_control_loop_pipe_no_ap_cont flow_control_loop_pipe_no_ap_cont_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(1'b1),
    .ap_ready(ap_ready),
...
ConvolutionInputGenerator_hls_0_regslice_both #(
    .DataWidth( 8 ))
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_400)) begin
        if ((icmp_ln1907_fu_161_p2 == 1'd0)) begin
            i_fu_72 <= i_2_fu_167_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_400)) begin
        if (((we_fu_194_p2 == 1'd1) & (icmp_ln1907_fu_161_p2 == 1'd0))) begin
            inp_count_fu_88 <= inp_count_1_fu_228_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            inp_count_fu_88 <= 32'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_400)) begin
        if (((icmp_ln1907_fu_161_p2 == 1'd0) & (re_fu_176_p2 == 1'd0))) begin
            ocnt_fu_80 <= ocnt_2_fu_212_p3;
        end else if ((ap_loop_init == 1'b1)) begin
            ocnt_fu_80 <= 32'd2;
        end
    end
...
always @ (posedge ap_clk) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | ((ap_predicate_op72_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op49_read_state1 == 1'b1) & (in0_V_TVALID_int_regslice == 1'b0)) | ((1'b1 == ap_CS_iter3_fsm_state4) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state4_io) | ((ap_predicate_op73_write_state4 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))))) & (1'b1 == ap_CS_iter0_fsm_state1) & (ap_loop_init == 1'b1))) begin
        rp_fu_84 <= 32'd0;
    end else if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | ((ap_predicate_op72_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((1'b1 == ap_CS_iter3_fsm_state4) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state4_io) | ((ap_predicate_op73_write_state4 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))))) & (1'b1 == ap_CS_iter1_fsm_state2) & (re_reg_371_pp0_iter0_reg == 1'd0) & (icmp_ln1907_reg_367_pp0_iter0_reg == 1'd0))) begin
        rp_fu_84 <= rp_2_fu_286_p3;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | ((ap_predicate_op72_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op49_read_state1 == 1'b1) & (in0_V_TVALID_int_regslice == 1'b0)) | ((1'b1 == ap_CS_iter3_fsm_state4) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state4_io) | ((ap_predicate_op73_write_state4 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))))) & (1'b1 == ap_CS_iter0_fsm_state1) & (ap_loop_init == 1'b1))) begin
        wp_fu_76 <= 32'd0;
    end else if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | ((ap_predicate_op72_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((1'b1 == ap_CS_iter3_fsm_state4) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state4_io) | ((ap_predicate_op73_write_state4 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))))) & (1'b1 == ap_CS_iter1_fsm_state2) & (icmp_ln1924_reg_379_pp0_iter0_reg == 1'd1) & (we_reg_375_pp0_iter0_reg == 1'd1) & (icmp_ln1907_reg_367_pp0_iter0_reg == 1'd0))) begin
        wp_fu_76 <= wp_2_fu_319_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | ((ap_predicate_op72_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op49_read_state1 == 1'b1) & (in0_V_TVALID_int_regslice == 1'b0)) | ((1'b1 == ap_CS_iter3_fsm_state4) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state4_io) | ((ap_predicate_op73_write_state4 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))))) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
        icmp_ln1907_reg_367 <= icmp_ln1907_fu_161_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | ((ap_predicate_op72_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((1'b1 == ap_CS_iter3_fsm_state4) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state4_io) | ((ap_predicate_op73_write_state4 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))))) & (1'b1 == ap_CS_iter1_fsm_state2))) begin
        icmp_ln1907_reg_367_pp0_iter1_reg <= icmp_ln1907_reg_367;
        re_reg_371_pp0_iter1_reg <= re_reg_371;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((1'b1 == ap_block_state3_io) | ((ap_predicate_op72_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)) | ((1'b1 == ap_CS_iter3_fsm_state4) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state4_io) | ((ap_predicate_op73_write_state4 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))))) & (1'b1 == ap_CS_iter2_fsm_state3))) begin
        icmp_ln1907_reg_367_pp0_iter2_reg <= icmp_ln1907_reg_367_pp0_iter1_reg;
        re_reg_371_pp0_iter2_reg <= re_reg_371_pp0_iter1_reg;
    end
end

always @ (posedge ap_clk) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | ((ap_predicate_op72_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op49_read_state1 == 1'b1) & (in0_V_TVALID_int_regslice == 1'b0)) | ((1'b1 == ap_CS_iter3_fsm_state4) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state4_io) | ((ap_predicate_op73_write_state4 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))))) & (1'b1 == ap_CS_iter0_fsm_state1) & (we_fu_194_p2 == 1'd1) & (icmp_ln1907_fu_161_p2 == 1'd0))) begin
        icmp_ln1924_reg_379 <= icmp_ln1924_fu_234_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | ((ap_predicate_op72_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op49_read_state1 == 1'b1) & (in0_V_TVALID_int_regslice == 1'b0)) | ((1'b1 == ap_CS_iter3_fsm_state4) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state4_io) | ((ap_predicate_op73_write_state4 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))))) & (1'b1 == ap_CS_iter0_fsm_state1) & (ap_predicate_op49_read_state1 == 1'b1))) begin
        in0_V_read_reg_383 <= in0_V_TDATA_int_regslice;
    end
end

always @ (posedge ap_clk) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | ((ap_predicate_op72_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op49_read_state1 == 1'b1) & (in0_V_TVALID_int_regslice == 1'b0)) | ((1'b1 == ap_CS_iter3_fsm_state4) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state4_io) | ((ap_predicate_op73_write_state4 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))))) & (1'b1 == ap_CS_iter0_fsm_state1) & (icmp_ln1907_fu_161_p2 == 1'd0))) begin
        re_reg_371 <= re_fu_176_p2;
        we_reg_375 <= we_fu_194_p2;
    end
end
...
always @ (*) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | ((ap_predicate_op72_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op49_read_state1 == 1'b1) & (in0_V_TVALID_int_regslice == 1'b0)) | ((1'b1 == ap_CS_iter3_fsm_state4) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state4_io) | ((ap_predicate_op73_write_state4 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))))) & (1'b1 == ap_CS_iter0_fsm_state1) & (icmp_ln1907_fu_161_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_iter0_fsm_state1) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_inp_count_load = inp_count_fu_88;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_iter0_fsm_state1) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_ocnt_load = ocnt_fu_80;
    end
end
...
always @ (*) begin
    case (ap_CS_iter3_fsm)
        ap_ST_iter3_fsm_state4 : begin
            ...
            end else if ((~((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state4_io) | ((ap_predicate_op73_write_state4 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))) & (icmp_ln1907_reg_367_pp0_iter2_reg == 1'd1) & (1'b1 == ap_CS_iter3_fsm_state4))) begin
...
assign add_ln1916_fu_280_p2 = ($signed(rp_fu_84) + $signed(32'd4294967295));
...
always @ (*) begin
    ap_condition_400 = (~(((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | ((ap_predicate_op72_write_state3 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op49_read_state1 == 1'b1) & (in0_V_TVALID_int_regslice == 1'b0)) | ((1'b1 == ap_CS_iter3_fsm_state4) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state4_io) | ((ap_predicate_op73_write_state4 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0))))) & (1'b1 == ap_CS_iter0_fsm_state1));
end

always @ (*) begin
    ap_predicate_op49_read_state1 = ((icmp_ln1924_fu_234_p2 == 1'd1) & (we_fu_194_p2 == 1'd1) & (icmp_ln1907_fu_161_p2 == 1'd0));
end

always @ (*) begin
    ap_predicate_op72_write_state3 = ((re_reg_371_pp0_iter1_reg == 1'd0) & (icmp_ln1907_reg_367_pp0_iter1_reg == 1'd0));
end

always @ (*) begin
    ap_predicate_op73_write_state4 = ((re_reg_371_pp0_iter2_reg == 1'd0) & (icmp_ln1907_reg_367_pp0_iter2_reg == 1'd0));
end
...
assign buffer_V_address0 = zext_ln1912_fu_253_p1;

assign buffer_V_address1 = zext_ln1925_fu_302_p1;

assign i_2_fu_167_p2 = (ap_sig_allocacmp_i_1 + 7'd1);

assign icmp_ln1907_fu_161_p2 = ((ap_sig_allocacmp_i_1 == 7'd91) ? 1'b1 : 1'b0);

assign icmp_ln1907_reg_367_pp0_iter0_reg = icmp_ln1907_reg_367;

assign icmp_ln1910_1_fu_188_p2 = ((ap_sig_allocacmp_ocnt_load == 32'd0) ? 1'b1 : 1'b0);

assign icmp_ln1910_fu_182_p2 = ((ap_sig_allocacmp_i_1 < 7'd3) ? 1'b1 : 1'b0);

assign icmp_ln1916_fu_274_p2 = ((tmp_fu_264_p4 != 31'd0) ? 1'b1 : 1'b0);

assign icmp_ln1921_fu_206_p2 = ((ocnt_1_fu_200_p2 == 32'd3) ? 1'b1 : 1'b0);

assign icmp_ln1924_fu_234_p2 = ((inp_count_1_fu_228_p2 < 32'd33) ? 1'b1 : 1'b0);

assign icmp_ln1924_reg_379_pp0_iter0_reg = icmp_ln1924_reg_379;

assign icmp_ln1926_fu_313_p2 = ((wp_1_fu_307_p2 == 32'd2) ? 1'b1 : 1'b0);

assign in0_V_TREADY = regslice_both_in0_V_U_ack_in;

assign inp_count_1_fu_228_p2 = (ap_sig_allocacmp_inp_count_load + 32'd1);

assign ocnt_1_fu_200_p2 = (ap_sig_allocacmp_ocnt_load + 32'd1);

assign ocnt_2_fu_212_p3 = ((icmp_ln1921_fu_206_p2[0:0] == 1'b1) ? 32'd0 : ocnt_1_fu_200_p2);

assign out_V_TVALID = regslice_both_out_V_U_vld_out;

assign re_fu_176_p2 = ((ap_sig_allocacmp_i_1 == 7'd0) ? 1'b1 : 1'b0);

assign re_reg_371_pp0_iter0_reg = re_reg_371;

assign rp_1_fu_258_p2 = (rp_fu_84 + 32'd1);

assign rp_2_fu_286_p3 = ((icmp_ln1916_fu_274_p2[0:0] == 1'b1) ? add_ln1916_fu_280_p2 : rp_1_fu_258_p2);

assign tmp_fu_264_p4 = {{rp_1_fu_258_p2[31:1]}};

assign we_fu_194_p2 = (icmp_ln1910_fu_182_p2 | icmp_ln1910_1_fu_188_p2);

assign we_reg_375_pp0_iter0_reg = we_reg_375;

assign wp_1_fu_307_p2 = (wp_fu_76 + 32'd1);

assign wp_2_fu_319_p3 = ((icmp_ln1926_fu_313_p2[0:0] == 1'b1) ? 32'd0 : wp_1_fu_307_p2);

assign zext_ln1912_fu_253_p1 = rp_fu_84;

assign zext_ln1925_fu_302_p1 = wp_fu_76;

endmodule //ConvolutionInputGenerator_hls_0
