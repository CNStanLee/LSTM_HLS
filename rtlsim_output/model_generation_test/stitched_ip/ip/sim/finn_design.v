...
module MVAU_hls_0_imp_7OH4JA
  ...
  wire [95:0]MVAU_hls_0_wstrm_m_axis_0_TDATA;
...
module MVAU_hls_1_imp_ZIW0NT
  ...
  assign ap_clk_1 = ap_clk;
  assign ap_rst_n_1 = ap_rst_n;
  assign in0_V_1_TDATA = in0_V_tdata[63:0];
  assign in0_V_1_TVALID = in0_V_tvalid;
  assign in0_V_tready = in0_V_1_TREADY;
  assign out_V_tdata[255:0] = MVAU_hls_1_out_V_TDATA;
...
(* CORE_GENERATION_INFO = "finn_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=finn_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=19,numReposBlks=17,numNonXlnxBlks=2,numHierBlks=2,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=4,numHdlrefBlks=11,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "finn_design.hwdef" *) 
module finn_design
   (ap_clk,
    ap_rst_n,
    m_axis_0_tdata,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis_0 " *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axis_0, CLK_DOMAIN finn_design_ap_clk_0, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 0, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 32, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [255:0]m_axis_0_tdata;
  ...
  wire [7:0]ConvolutionInputGenerator_hls_0_out_V_TDATA;
  wire ConvolutionInputGenerator_hls_0_out_V_TREADY;
  wire ConvolutionInputGenerator_hls_0_out_V_TVALID;
  wire [127:0]ConvolutionInputGenerator_hls_1_out_V_TDATA;
  wire ConvolutionInputGenerator_hls_1_out_V_TREADY;
  wire ConvolutionInputGenerator_hls_1_out_V_TVALID;
  wire [31:0]MVAU_hls_0_out_V_TDATA;
  wire MVAU_hls_0_out_V_TREADY;
  wire MVAU_hls_0_out_V_TVALID;
  wire [255:0]MVAU_hls_1_out_V_TDATA;
  wire MVAU_hls_1_out_V_TREADY;
  wire MVAU_hls_1_out_V_TVALID;
  wire [23:0]StreamingDataWidthConverter_rtl_0_out_V_TDATA;
  ...
  wire [31:0]StreamingFIFO_rtl_3_out_V_TDATA;
  ...
  wire [255:0]StreamingFIFO_rtl_7_out_V_TDATA;
  ...
  assign StreamingFIFO_rtl_7_out_V_TREADY = m_axis_0_tready;
  assign ap_clk_0_1 = ap_clk;
  assign ap_rst_n_0_1 = ap_rst_n;
  assign in0_V_0_1_TDATA = s_axis_0_tdata[7:0];
  assign in0_V_0_1_TVALID = s_axis_0_tvalid;
  assign m_axis_0_tdata[255:0] = StreamingFIFO_rtl_7_out_V_TDATA;
  assign m_axis_0_tvalid = StreamingFIFO_rtl_7_out_V_TVALID;
  assign s_axis_0_tready = in0_V_0_1_TREADY;
  finn_design_ConvolutionInputGenerator_hls_0_0 ConvolutionInputGenerator_hls_0
       (.ap_clk(ap_clk_0_1),
        ...
        .out_V_TDATA(ConvolutionInputGenerator_hls_0_out_V_TDATA),
        .out_V_TREADY(ConvolutionInputGenerator_hls_0_out_V_TREADY),
        .out_V_TVALID(ConvolutionInputGenerator_hls_0_out_V_TVALID));
  finn_design_ConvolutionInputGenerator_hls_1_0 ConvolutionInputGenerator_hls_1
       (.ap_clk(ap_clk_0_1),
        .ap_rst_n(ap_rst_n_0_1),
        ...
        .out_V_TDATA(ConvolutionInputGenerator_hls_1_out_V_TDATA),
        .out_V_TREADY(ConvolutionInputGenerator_hls_1_out_V_TREADY),
        .out_V_TVALID(ConvolutionInputGenerator_hls_1_out_V_TVALID));
  ...
  finn_design_StreamingFIFO_rtl_1_0 StreamingFIFO_rtl_1
       (.ap_clk(ap_clk_0_1),
        .ap_rst_n(ap_rst_n_0_1),
        .in0_V_TDATA(ConvolutionInputGenerator_hls_0_out_V_TDATA),
        .in0_V_TREADY(ConvolutionInputGenerator_hls_0_out_V_TREADY),
        .in0_V_TVALID(ConvolutionInputGenerator_hls_0_out_V_TVALID),
  ...
  finn_design_StreamingFIFO_rtl_5_0 StreamingFIFO_rtl_5
       (.ap_clk(ap_clk_0_1),
        .ap_rst_n(ap_rst_n_0_1),
        .in0_V_TDATA(ConvolutionInputGenerator_hls_1_out_V_TDATA),
        .in0_V_TREADY(ConvolutionInputGenerator_hls_1_out_V_TREADY),
        .in0_V_TVALID(ConvolutionInputGenerator_hls_1_out_V_TVALID),
