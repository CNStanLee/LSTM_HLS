...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in0_V_TDATA { I 24 vector } in0_V_TVALID { I 1 bit } in0_V_TREADY { O 1 bit } } \
} "
} else {
...
# RegSlice definition:
set ID 172
set RegSliceName MVAU_hls_0_regslice_both
set RegSliceInstName MVAU_hls_0_regslice_both_U
set CoreName ap_simcore_MVAU_hls_0_regslice_both
