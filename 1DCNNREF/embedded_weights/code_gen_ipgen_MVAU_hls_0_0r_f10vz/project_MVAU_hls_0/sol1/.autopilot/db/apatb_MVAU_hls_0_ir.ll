; ModuleID = '/tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_0_0r_f10vz/project_MVAU_hls_0/sol1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_MVAU_hls_0_ir(%"class.hls::stream<ap_uint<24>, 0>"* noalias nocapture nonnull dereferenceable(4) %in0_V, %"class.hls::stream<ap_uint<32>, 0>"* noalias nocapture nonnull dereferenceable(4) %out_V) local_unnamed_addr #1 {
entry:
  %in0_V_copy = alloca %"class.hls::stream<ap_uint<24>, 0>", align 512
  call void @llvm.sideeffect() #7 [ "stream_interface"(%"class.hls::stream<ap_uint<24>, 0>"* %in0_V_copy, i32 0) ]
  %out_V_copy = alloca %"class.hls::stream<ap_uint<32>, 0>", align 512
  call void @llvm.sideeffect() #7 [ "stream_interface"(%"class.hls::stream<ap_uint<32>, 0>"* %out_V_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<ap_uint<24>, 0>"* nonnull %in0_V, %"class.hls::stream<ap_uint<24>, 0>"* nonnull align 512 %in0_V_copy, %"class.hls::stream<ap_uint<32>, 0>"* nonnull %out_V, %"class.hls::stream<ap_uint<32>, 0>"* nonnull align 512 %out_V_copy)
  call void @apatb_MVAU_hls_0_hw(%"class.hls::stream<ap_uint<24>, 0>"* %in0_V_copy, %"class.hls::stream<ap_uint<32>, 0>"* %out_V_copy)
  call void @copy_back(%"class.hls::stream<ap_uint<24>, 0>"* %in0_V, %"class.hls::stream<ap_uint<24>, 0>"* %in0_V_copy, %"class.hls::stream<ap_uint<32>, 0>"* %out_V, %"class.hls::stream<ap_uint<32>, 0>"* %out_V_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<ap_uint<24>, 0>"* noalias, %"class.hls::stream<ap_uint<24>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<32>, 0>"* noalias, %"class.hls::stream<ap_uint<32>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<24>, 0>"(%"class.hls::stream<ap_uint<24>, 0>"* align 512 %1, %"class.hls::stream<ap_uint<24>, 0>"* %0)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<ap_uint<24>, 0>"* noalias, %"class.hls::stream<ap_uint<24>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<32>, 0>"* noalias, %"class.hls::stream<ap_uint<32>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<24>, 0>"(%"class.hls::stream<ap_uint<24>, 0>"* %0, %"class.hls::stream<ap_uint<24>, 0>"* align 512 %1)
...
declare void @apatb_MVAU_hls_0_hw(%"class.hls::stream<ap_uint<24>, 0>"*, %"class.hls::stream<ap_uint<32>, 0>"*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(%"class.hls::stream<ap_uint<24>, 0>"* noalias, %"class.hls::stream<ap_uint<24>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<32>, 0>"* noalias, %"class.hls::stream<ap_uint<32>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<24>, 0>"(%"class.hls::stream<ap_uint<24>, 0>"* %0, %"class.hls::stream<ap_uint<24>, 0>"* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<32>, 0>"(%"class.hls::stream<ap_uint<32>, 0>"* %2, %"class.hls::stream<ap_uint<32>, 0>"* align 512 %3)
  ret void
...
define void @MVAU_hls_0_hw_stub_wrapper(%"class.hls::stream<ap_uint<24>, 0>"*, %"class.hls::stream<ap_uint<32>, 0>"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream<ap_uint<24>, 0>"* null, %"class.hls::stream<ap_uint<24>, 0>"* %0, %"class.hls::stream<ap_uint<32>, 0>"* null, %"class.hls::stream<ap_uint<32>, 0>"* %1)
  call void @MVAU_hls_0_hw_stub(%"class.hls::stream<ap_uint<24>, 0>"* %0, %"class.hls::stream<ap_uint<32>, 0>"* %1)
  call void @copy_in(%"class.hls::stream<ap_uint<24>, 0>"* null, %"class.hls::stream<ap_uint<24>, 0>"* %0, %"class.hls::stream<ap_uint<32>, 0>"* null, %"class.hls::stream<ap_uint<32>, 0>"* %1)
  ret void
}

declare void @MVAU_hls_0_hw_stub(%"class.hls::stream<ap_uint<24>, 0>"*, %"class.hls::stream<ap_uint<32>, 0>"*)
