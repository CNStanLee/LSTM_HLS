...
// wrapc file define:
#define AUTOTB_TVIN_in0_V "../tv/cdatafile/c.MVAU_hls_0.autotvin_in0_V.dat"
#define WRAPC_STREAM_SIZE_IN_in0_V "../tv/stream_size/stream_size_in_in0_V.dat"
#define WRAPC_STREAM_INGRESS_STATUS_in0_V "../tv/stream_size/stream_ingress_status_in0_V.dat"
#define AUTOTB_TVOUT_out_V "../tv/cdatafile/c.MVAU_hls_0.autotvout_out_V.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_out_V "../tv/rtldatafile/rtl.MVAU_hls_0.autotvout_out_V.dat"
...
extern "C"
void MVAU_hls_0_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_MVAU_hls_0_hw(void* __xlx_apatb_param_in0_V, void* __xlx_apatb_param_out_V)
{
  static hls::sim::Stream<hls::sim::Byte<4>> port0 {
    .width = 24,
    .name = "in0_V",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_in0_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_in0_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_in0_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_in0_V),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_in0_V;
  ...
  static hls::sim::Stream<hls::sim::Byte<4>> port1 {
    ...
    .name = "out_V",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_out_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_out_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_out_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_out_V),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_out_V;
  port1.hasWrite = true;
  ...
  try {
    ...
    MVAU_hls_0_hw_stub_wrapper(__xlx_apatb_param_in0_V, __xlx_apatb_param_out_V);
    port1.buffer();
