...
set config_proj_name project_MVAU_hls_1
puts "HLS project: $config_proj_name"
set config_hwsrcdir "/tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_1_s2v7bp4p"
...
set config_toplevelfxn "MVAU_hls_1"
set config_clkperiod 10.0

open_project $config_proj_name
add_files $config_hwsrcdir/top_MVAU_hls_1.cpp -cflags "-std=c++14 -I$config_bnnlibdir -I$config_customhlsdir"
