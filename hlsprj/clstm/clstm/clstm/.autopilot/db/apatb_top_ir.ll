; ModuleID = '/home/changhong/prj/finn_dev/finn/script/LSTM_HLS/hlsprj/clstm/clstm/clstm/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline optnone
define i32 @apatb_top_ir() local_unnamed_addr #0 {
entry:
  call fastcc void @copy_in()
  %0 = call i32 @apatb_top_hw()
  call void @copy_back()
  ret i32 %0
}
...
define i32 @top_hw_stub_wrapper() #3 {
entry:
  call void @copy_out()
  %0 = call i32 @top_hw_stub()
  call void @copy_in()
  ret i32 %0
}

declare i32 @top_hw_stub()
