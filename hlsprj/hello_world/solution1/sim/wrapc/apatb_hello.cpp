...
// wrapc file define:
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.hello.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.hello.autotvout_ap_return.dat"
...
extern "C"
hls::sim::Byte<4> hello_hw_stub_wrapper();

extern "C"
hls::sim::Byte<4> apatb_hello_hw()
{
  ...
  try {
    ...
    ap_return = hello_hw_stub_wrapper();
