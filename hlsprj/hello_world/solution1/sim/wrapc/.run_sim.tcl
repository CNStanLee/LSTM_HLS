...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hello.autotvin.dat"
	set constFileTvOut       "hello.autotvout.dat"
	set constFileHdlTvIn     "hello.autohdltvin.dat"
	set constFileHdlTvOut    "hello.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
